            ...
            self.env['salon.order.line'].create({
                ...
                'salon_order_id': self.env['salon.order'].create(
                        {'customer_name': self.name,
                         ...
                         'stage_id': self.env.ref('salon_management.salon_stage_00', raise_if_not_found=False).id if self.env.ref('salon_management.salon_stage_00', raise_if_not_found=False) else False,
